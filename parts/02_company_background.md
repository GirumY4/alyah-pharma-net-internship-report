## Brief History of the Hosting Organization
...
Business at the University of Michigan. The group was built to close three
structural gaps in Ethiopia's digital economy at once: the absence of
affordable, locally relevant business software; a shortage of practical,
industry-ready digital skills among young people; and the lack of a
trustworthy channel connecting trained talent to real economic opportunity.
To address these gaps simultaneously, Alyah Technologies operates through
three interconnected platforms: Alyah Software, an enterprise software
...
add value to clients; its mission is to provide turnkey software solutions
...
Aezop onboarded 573 freelancers and clients, while Alyah Software reports
being trusted by more than 20 organizations with over 50 systems deployed.
The company has built academic partnerships that extend its reach into
universities, most notably with Bahir Dar University: in April 2026, Alyah
Software co-sponsored the Women in STEAM Ethiopia Digital Hackathon
...
- Finance and accounting, automating bookkeeping and generating decision insights;
- Human resources, managing payroll and employee data;
- Procurement, optimizing purchasing processes and vendor management;
- Business intelligence, providing real-time analytics and reporting.

Beyond the core ERP, the division offers government and institutional
solutions with compliance-ready architecture, multi-department support, and
...
### Alyah Innovation Hub — Talent Development
...
Aezop positions itself as Africa's trusted, escrow-protected freelance
network, built to solve problems that global platforms do not solve well in
the African context: systemic bias, payment friction, trust deficits, and
competitive barriers for local freelancers. Its defining features are
verified freelancers and clients through rigorous identity and skill checks;
...
Each platform in the Alyah group serves a distinct but connected audience.
Alyah Software's clients are small and medium enterprises managing sales,
inventory, finance, and human resources; government bureaus and public
organizations needing compliance-ready, auditable systems; NGOs and
non-profits digitizing their operations; and educational institutions,
including Bahir Dar University and the Bahir Dar Institute of Technology,
engaged through partnership and sponsorship. The Innovation Hub serves
students and young innovators from universities and high schools, tech
enthusiasts seeking practical digital skills, and aspiring entrepreneurs,
...
Alyah Technologies is structured as one holding group sitting above three
operating platforms — Alyah Software, Alyah Innovation Hub, and Aezop. Rather
than giving each platform its own separate department stack, the group runs
on a lean, shared-team model: the same core people work across engineering,
business development, and marketing for all three brands, coordinated
centrally by the founder. Group leadership rests with Henok Alelign, CEO and
Founder, who sets overall strategy and represents the group externally. At
platform level, Alyah Software is the group's enterprise revenue engine and
the most mature platform, and it is where the Core Software Engineer role is
...
| Name                | Role                              | Platforms Supported                                                                                          |
| ------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Ermias Antigegn     | Core Software Engineer            | Alyah Software (ERP and custom builds); the underlying technology behind Aezop's matching and escrow systems |
| Mahlet Atinafu      | Ecosystem Growth & Marketing Lead | Alyah Innovation Hub (program and partnerships); Aezop (talent-to-marketplace pipeline)                      |
| Sewite Kassie Abate | Business Development Officer      | Alyah Software (institutional clients); Aezop (client acquisition)                                           |
| Betelhem Birhanu    | Marketing & Promotion Officer     | All three platforms — brand promotion and online presence                                                    |

This structure reflects an integrated strategy: engineering resources are
shared across software development and platform maintenance, while marketing
and business development serve all three brands rather than operating as
...
### Software Development Life Cycle — Alyah Software
...
3. Development and customization — engineers configure and, where needed, code custom features so the system matches the client's actual workflows.
4. Testing and quality assurance — the configured system is tested against the client's real business scenarios to catch errors before go-live.
5. Deployment and training — the system goes live in the client's environment with hands-on training for client staff.
6. Maintenance and support — the company provides ongoing local support, bug fixes, and updates; issues raised during support feed back into the requirements stage for the next improvement cycle.

Depending on the client and the project, this life cycle is executed under
either an Agile (Scrum) approach — preferred when initial requirements are
...
The Innovation Hub operates a three-stage pipeline: recruitment and
onboarding, in which innovators apply online or in person in Bahir Dar;
...
| -------------------- | -------------------------------------------- | ---------------------------------------------------- | -------------------------------------------------------- |
| Onboarding           | Creates a verified client profile            | Verifies identity, skills, and profile of both sides | Creates a verified freelancer profile and skill showcase |
| Matching             | Posts a job with scope and budget            | Ranks best-fit freelancers using AI matching         | Browses open jobs or is surfaced to the client           |
| Engagement           | Reviews proposals and selects a freelancer   | Facilitates bidding, messaging, and offer acceptance | Submits a proposal or bid for the posted job             |
| Funding and delivery | Funds the project and reviews each milestone | Holds payment in escrow and tracks milestone status  | Begins work and submits completed milestones             |
| Completion           | Approves work and rates the freelancer       | Releases escrow payment; mediates any dispute        | Receives payment and rates the client                    |
...
Internally, the group's work is organized into three functional areas:
engineering, which builds and maintains Alyah ERP, Aezop's matching and
escrow systems, and custom AI solutions; business development and
partnerships, which manages academic, government, and corporate
relationships across all three platforms; and marketing and ecosystem growth,
which promotes all three platforms and aligns the Innovation Hub with Aezop
so that trained talent flows into paid opportunity. Taken together, these
...
experience of Part Three and the project work of Part Four were carried out.
